                ...
                <div class="row ">
                    <div class="col-sm-6 d-flex align-items-center">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"> Rank and Reward Trashed</a></li>
                        </ol>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-auto text-right" style="cursor: pointer;">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('admin.reward.trashed.restore',$value->id)}}" title="Restore"><i class="fas fa-sync-alt" style="color: #3A82EF;"></i> Restore</a>
                                                                    <a class="dropdown-item" data-bs-target="#deleteConfirm" href="javascript:void(0);" 
                                                                        data-bs-toggle="modal" title="Delete" 
                                                                        onclick="deleteConfirm('{{ route('admin.reward.trashed.destroy',$value->id)}}')"><i class="fa fa-trash" style="color: red;"></i> Delete</a>
