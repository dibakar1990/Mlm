...
class UserPassbookExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    /**
    ...
    */
    ...
    {
        $passbooks = Passbook::where('user_id',Auth::user()->id)->with('user')->get();
